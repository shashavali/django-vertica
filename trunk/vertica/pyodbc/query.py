"""
Custom Query class for Vertica SQL Server.
...
# Cache. Maps default query class to new Vertica SQL query class.
_classes = {}
...
def query_class(QueryClass):
    ...
    appropriate for Vertica SQL Server.
    """
    global _classes
    try:
    ...
    class PyOdbcSSQuery(QueryClass):
        from vertica.pyodbc import aggregates
